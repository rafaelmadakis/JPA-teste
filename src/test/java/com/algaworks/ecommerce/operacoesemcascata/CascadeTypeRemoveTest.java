...
//    @Test
    public void removeRelacaoProdutoCategoria(){
...
//    @Test
    public void removerPedidoEItens() {
        ...
        entityManager.getTransaction().begin();
        entityManager.remove(pedido); // Necessário Caqscadetype.REMOVE no atributo "itens"
        entityManager.getTransaction().commit();
...
//    @Test
    public void removerItemPedidoEPedido() {
        ...
        entityManager.getTransaction().begin();
        entityManager.remove(itemPedido); // Necessário Caqscadetype.REMOVE no atributo "pedido"
        entityManager.getTransaction().commit();
