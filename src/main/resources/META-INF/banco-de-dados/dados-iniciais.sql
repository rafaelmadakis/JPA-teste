...
insert into cliente (id, nome, cpf) values (1, 'Fernando Medeiros', '122341234');
insert into cliente (id, nome, cpf) values (2, 'Marcos Mariano', '000');

insert into cliente_detalhe (cliente_id, sexo, data_nascimento) values (1, 'MASCULINO', date_sub(sysdaate(),interval  27 year ));
insert into cliente_detalhe (cliente_id, sexo, data_nascimento) values (2, 'MASCULINO', date_sub(sysdaate(),interval  30 year ));
